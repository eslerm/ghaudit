...
func all(githubClient *github.Client, orgPtr *string) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return runChecks(cmd.Context(), githubClient, *orgPtr, true, includeArchived, limitedAccess, errorsOnly)
		},
	}
